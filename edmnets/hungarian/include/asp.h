...
//and by some further adaptations by moritz.hoffmann@fu-berlin.de

#pragma once

namespace edmnets::hungarian::asp {

#define INF 100000

template<template<typename> typename CostMatrix, typename cost>
void asp(int size, CostMatrix<cost> Array, long *col_mate, long *row_mate) {
...
//long*row_mate;
    ...
    parent_row = new long[n];
    for (i = 0; i < n; ++i) parent_row[i] = 0;
    unchosen_row = new long[m];
